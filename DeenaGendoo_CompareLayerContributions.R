...
"TRYPTOPHAN","ALVOCIDIB","ABIRATERONE","THAPSIGARGIN","KINETINRIBOSIDE","ELLIPTICINE")    

InterestDrug<-"DIPYRIDAMOLE" #dipyridamole,fluvastatin,methotrexate
NumHits<-23 #Number of top hits to tabulate agains the query dru. Use ALL DRUGS 
...
legend(x=1, y=1, legend = rownames(SpecificNew[-c(1,2),]), bty = "n", pch=20 , 
       col=colors_in , text.col = "grey", cex=0.8, pt.cex=2)
dev.off()
